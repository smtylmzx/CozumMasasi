...
+ "<input type='text' class='form-control input-lg' placeholder='Etiket arayýn' name='search' required>"
		...
		out.print("<div class='panel-body'>"); 	
				for (int i = 0; i < resultlastyuz.size(); i++) { 
					 out.print("<div class='item' style='float:left; margin-left:8px; margin-top:8px;'>"
					 		+ "<span class='tago"+ i +"'><a href='TagSearch?tagid=" + resultlastyuz.get(i).getTagID() + "'>#"+ resultlastyuz.get(i).getTag() + "</a></br>"
